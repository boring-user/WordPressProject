...
/*$output.="<b>Name :</b> $name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Email :</b> $email<br>
		<b>Subject :</b> $subject<br><b>Message :</b> ".nl2br($message)."<br><br>";*/

//$output.="has been sent. We will respond as soon as possible.";

$headers="From: ".get_option('home')." <$email>\r\n";
$headers .= "Content-Type: text/html; charset=utf-8\r\n";
$msg="<b>Name :</b> $name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Phone :</b> $phone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Email :</b> $email<br><br>
...
if(isset($_POST['yname'])) {
	...
	$headers .= "Content-Type: text/html; charset=utf-8 \r\n";
	/*$msg="<b>Name :</b> $yname &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Address :</b> $address <br><br>
	<b>City :</b> $city &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>State :</b>$state &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Zip :</b>$zip<br><br>
	<b>Phone :</b> $phone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Email :</b> $email";*/
	$msg="<b>Name :</b> $yname<br><br>
...
$headers .= "Content-Type: text/html; charset=utf-8\r\n";
$msg="<b>Name :</b> $uname &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Email :</b> $email<br><br>
