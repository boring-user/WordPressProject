...
<a href='https://www.facebook.com/dialog/feed?app_id=881949731891747&link=<?php echo urlencode("http://webphics.com/wordpress/wp_dalmiaadvisory/"); ?>&name=<?php echo urlencode(get_the_title()); ?>&description=<?php echo urlencode(get_the_excerpt()); ?>&picture=<?php echo urlencode($thumbfront[0]); ?>&redirect_uri=<?php echo urlencode("http://webphics.com/wordpress/wp_dalmiaadvisory/"); ?>' target='_blank'><img src='<?php bloginfo('template_directory'); ?>/images/fbicon1.png' alt='Facebook' class='fbiconew'/></a>
