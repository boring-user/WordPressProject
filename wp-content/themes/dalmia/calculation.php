...
t.className='onlyscreen';
    ...
    <h2><?php echo $title; ?></h2>
        ...
        <div class="content-left-prasun" style="float: left!important;width: 100%!important;">
        <?php the_content(); ?>
        
         <?php 
		 $calpath=site_url().'/calculation/';
		 ?>
        ...
        <td style="border: 0px solid #CCC;padding: 5px 12px 5px 12px;"><input name="A2" type="text" id="A2" size="12" onkeyup="javascript:revdual(this.value,document.form1.A1)" style="border: 1px solid #000;width: 100%;height: 30px;border-radius: 3px;padding-left: 5px;" readonly="readonly"/></td>
        </tr>
        <tr>
        <td style="color: #474747;border: 1px solid #CCC;padding: 5px 12px 5px 12px;font-family:'myriad Pro';border: 1px solid #E5E5E5;background:#E5E5E5;font-size:16px;">No. of Months / Years</td>
        ...
        <td style="border: 0px solid #CCC;padding: 5px 12px 5px 12px;"><input name="B2" type="text" id="B2" size="12" style="border: 1px solid #000;width: 100%;height: 30px;border-radius: 3px;padding-left: 5px;" readonly="readonly"/></td>
        </tr>
        <tr>
        <td style="color: #474747;border: 1px solid #CCC;padding: 5px 12px 5px 12px;font-family:'myriad Pro';border: 1px solid #E5E5E5;background:#E5E5E5;font-size:16px;">Expected Annual Return(%)</td>
        ...
        <td style="border: 0px solid #CCC;padding: 5px 12px 5px 12px;"><input name="C2" type="text" id="C2" size="12" style="border: 1px solid #000;width: 100%;height: 30px;border-radius: 3px;padding-left: 5px;" readonly="readonly"/></td>
        </tr>
        <tr>
