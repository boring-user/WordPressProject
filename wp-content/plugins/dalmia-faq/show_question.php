...
$table3 = NCL_TABLE_PREFIX."nri_fqcat";
...
<?php
$sql11 = "SELECT * FROM $table WHERE $table.nri_fqsubcat_id ='$sortvalue'";

$resultspp = $wpdb->get_results($sql11);

foreach($resultspp as $resultpp)
{
?>

<h2>Search Result : <span style="color:#7e1312;"><?php echo $resultpp->nri_fqsubcat_name ; ?></span></h2>
...
<td style='background:#212121;text-align:center;color:#FFF;font-size:14px;'>COPY URL</td>
...
$sql = "SELECT * FROM $table, $table2, $table3 WHERE $table.nri_fqsubcat_id = $table2.nri_fqsubcat_id AND $table.nri_fqsubcat_id ='$sortvalue' ORDER BY $table2.nri_ques_id DESC";
...
foreach($results as $result)
	...
	echo "<td style='background:#FFF;text-align:center;font-size:11px;'>".site_url()."/faq-on-personal-investment-and-finance/?page=&subcatid=".$result->nri_fqsubcat_id."&quesid=".$result->nri_ques_id."&parentfaqid=".$result->nri_fqcat_id."#".$result->nri_ques_id."</td>";		
